    ...
    <div className="p-10">
      ...
      <FormControl className="flex w-full flex-col gap-4">
          ...
          <Autocomplete
            ...
            renderInput={(params) => (
              <TextField
                ...
                data-testid="product-schema-project"
                variant="outlined"
                label="Project"
              />
            )}
          ...
          <Autocomplete
            ...
            renderInput={(params) => (
              <TextField
                ...
                data-testid="product-schema-theme"
                variant="outlined"
                label="Themes"
              />
            )}
        ...
        {schema.assets.length > 0 ? (
          <List>
            {schema.assets.map((u, idx) => (
              <ListItem
                data-testid="product-schema-asset"
                key={`product-asset-${idx}`}
                secondaryAction={
                  <IconButton
                    data-testid="product-schema-asset-delete"
                    edge="end"
                    aria-label="delete"
                    onClick={() => deleteAsset(u)}
                  >
                    <DeleteIcon />
                  </IconButton>
                }
          ...
          <span className="text-sm text-gray-500">
            No assets defined for the product. Specify at least one asset.
          </span>
        )}
        <div className="flex flex-col gap-2">
          <div className="flex gap-2">
            ...
            />
            <Button
              data-testid="product-schema-add-asset-button"
              disabled={newAssetName === "" || newAssetUrl === ""}
              onClick={addAsset}
              variant="contained"
              startIcon={<AddIcon />}
            >
