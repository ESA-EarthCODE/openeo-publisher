...
export const WorkflowForm = ({
    ...
    <>
      <Autocomplete
        ...
        onChange={(event, value) =>
          onFormChange(schema, "id", (value as EarthCODEWorfklowInfo)?.id)
        }
        ...
        renderInput={(params) => (
          <TextField
            ...
            data-testid="workflow-schema-workflow"
            variant="outlined"
            label="Workflow"
          />
        )}
        ...
        <Autocomplete
          ...
          renderInput={(params) => (
            <TextField
              ...
              data-testid="workflow-schema-project"
              variant="outlined"
              label="Project"
            />
          )}
        ...
        <Autocomplete
          ...
          renderInput={(params) => (
            <TextField
              ...
              data-testid="workflow-schema-theme"
              variant="outlined"
              label="Themes"
            />
          )}
  ...
  return (
    <div className="p-10">
      <span className="font-bold mb-5 text-xl flex items-center">Workflow</span>
      <FormControl className="flex w-full flex-col gap-4">
        ...
        {!schema.isExisting
          ? generateNewWorkflowForm()
          : generateExistingWorfklowForm()}
      </FormControl>
    </div>
  );
};
